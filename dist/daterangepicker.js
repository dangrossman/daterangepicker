...
(function ($, moment) {
  var DateRangePicker = function DateRangePicker(element, options, cb) {
    ...
    if (typeof options.template !== 'string' && !(options.template instanceof $)) options.template = '<div class="daterangepicker hidden">' + '<div class="container">' + '<div class="calendar left">' + '<div class="daterangepicker_input">' + '<div class="left icon ui input fluid small">' + '<input class="" type="text" name="daterangepicker_start" value="" />' + '<i class="icon calendar"></i>' + '</div>' + '<div class="calendar-time">' + '<i class="icon clock"></i>' + '<div></div>' + '</div>' + '</div>' + '<div class="calendar-table"></div>' + '</div>' + '<div class="calendar right">' + '<div class="daterangepicker_input">' + '<div class="left icon ui input fluid small">' + '<input class="" type="text" name="daterangepicker_end" value="" />' + '<i class="icon calendar"></i>' + '</div>' + '<div class="calendar-time">' + '<i class="icon clock"></i>' + '<div></div>' + '</div>' + '</div>' + '<div class="calendar-table"></div>' + '</div>' + '<div class="actions">' + '<button class="cancelBtn" type="button"></button>' + '<button class="applyBtn" disabled="disabled" type="button"></button> ' + '</div>' + '</div>' + '<div class="ranges">' + '</div>' + '</div>';
    ...
    this.container.find('.ranges').on('click.daterangepicker', 'li', $.proxy(this.clickRange, this)).on('mouseenter.daterangepicker', 'li', $.proxy(this.hoverRange, this)).on('mouseleave.daterangepicker', 'li', $.proxy(this.updateFormInputs, this));

    this.container.find('.actions').on('click.daterangepicker', 'button.applyBtn', $.proxy(this.clickApply, this)).on('click.daterangepicker', 'button.cancelBtn', $.proxy(this.clickCancel, this));
