...
/*global window, define, module, amd, require, document */
(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
        var start, end, range, iterator, val, split, maxDate, elem, rangeHtml, list;
    ...
    DateRangePicker.prototype = {
        ...
        updateMonthsInView: function () {
            ...
            if (this.maxDate && this.linkedCalendars
                    && !this.singleDatePicker && this.rightCalendar.month > this.maxDate) {
        ...
        renderCalendar: function (side) {
            ...
            var i, startDay, curDate, col, row, minDate, maxDate, arrow, html,
                m, dateHtml, currentMonth, currentYear, maxYear, minYear, inMinYear, inMaxYear, monthHtml,
                yearHtml, y, maxLimit, classes, isCustom, cname, disabled, selected,
                calendar = side === 'left' ? this.leftCalendar : this.rightCalendar,
            ...
            minDate = side === 'left' ? this.minDate : this.startDate;
            maxDate = this.maxDate;
            selected = side === 'left' ? this.startDate : this.endDate;
            arrow = this.locale.direction === 'ltr' ? {left: 'chevron-left', right: 'chevron-right'} : {left: 'chevron-right', right: 'chevron-left'};
            ...
            if (this.endDate == null && this.dateLimit) {
                maxLimit = this.startDate.clone().add(this.dateLimit).endOf('day');
            ...
            for (row = 0; row < 6; row += 1) {
                ...
                for (col = 0; col < 7; col += 1) {
                    ...
                    isCustom = this.isCustomDate(calendar[row][col]);
                    if (isCustom !== false) {
        ...
        renderTimePicker: function (side) {
            ...
            var html, selected, minDate, timeSelector, ampm, start, end,
                i, i_in_24, time, disabled, padded, am_html, pm_html,
                maxDate = this.maxDate;
            ...
            if (side === 'left') {
                ...
                timeSelector = this.container.find('.calendar.right .calendar-time div');
            ...
            start = this.timePicker24Hour ? 0 : 1;
        ...
        hoverDate: function (e) {
            ...
            if (!this.endDate) {
                this.container.find('.calendar td').each(function (index, el) {
                    ...
                    var innerTitle = $(el).attr('data-title'),
                        innerRow = innerTitle.substr(1, 1),
                        innerCol = innerTitle.substr(3, 1),
                        innerCal = $(el).parents('.calendar'),
                        dt = innerCal.hasClass('left')
                            ? leftCalendar.calendar[innerRow][innerCol]
                            : rightCalendar.calendar[innerRow][innerCol];
