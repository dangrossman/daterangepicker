...
`opens`: (string: 'left'/'right'/'center') Whether the picker appears aligned to the left, aligned to the right, or centered relative to the HTML element it's attached to
